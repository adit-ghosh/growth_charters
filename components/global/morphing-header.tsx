    ...
    >
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <Link
            href="https://app-growth-charters.netlify.app/login"
            className="hidden sm:inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all text-white hover:shadow-lg h-9 px-4 py-2"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-border bg-white dark:bg-slate-950/95 backdrop-blur-xl">
          <nav className="flex flex-col gap-4 p-6">
            ...
            <Link
              href="https://app-growth-charters.netlify.app/login"
              className="text-sm font-medium transition-colors hover:text-[#748759] mt-4"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Get Started
            </Link>
