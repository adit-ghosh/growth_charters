...
export default function DownloadPage() {
  const [activeDesktopTab, setActiveDesktopTab] = useState("windows")
  const [activeMobileTab, setActiveMobileTab] = useState("ios")
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-6 sm:pt-8 border-t border-border">
            <div>
              <p className="text-xs text-muted-foreground uppercase tracking-wide mb-1 sm:mb-2">Version</p>
            ...
            <div>
              <p className="text-xs text-muted-foreground uppercase tracking-wide mb-1 sm:mb-2">Released</p>
          ...
          >
            {Object.entries(desktopPlatforms).map(([key, platform]) => (
              ...
              >
                <span
                  className={`${
                    activeDesktopTab === key ? "text-foreground" : "text-muted-foreground hover:text-foreground"
                  }`}
                >
                  {platform.name}
                </span>
          ...
          >
            {Object.entries(mobilePlatforms).map(([key, platform]) => (
              ...
              >
                <span
                  className={`${
                    activeMobileTab === key ? "text-foreground" : "text-muted-foreground hover:text-foreground"
                  }`}
                >
                  {platform.name}
                </span>
